...
namespace Rhymix\Modules\Nicepay\Models;
...
class Config
{
	...
	public static function getConfig()
	{
		if (self::$_cache === null)
		{
			self::$_cache = ModuleModel::getModuleConfig('nicepay') ?: new \stdClass;
		}
		return self::$_cache;
	}
	...
	public static function setConfig($config)
	{
		...
		$result = $oModuleController->insertModuleConfig('nicepay', $config);
		if ($result->toBool())
		{
			self::$_cache = $config;
		}
